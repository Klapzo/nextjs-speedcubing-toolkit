export const cardsInfo = [
  ...
  // {title: "SKEWB", disabled: true, path: "skewb"},
  // {title: "CLOCK", disabled: true, path: "clock"},
  // {title: "MEGAMINX", disabled: true, path: "megaminx"},
  // {title: "PIRAMINX", disabled: true, path: "piraminx"},
  // {title: "SQUARE-1", disabled: true, path: "square1"},
]
